...
import talking from "../../../../../../assets/mascot/tardie-talking.svg"
...
export const TardigradeAgentIllustration = ({ working, thinking, done }: { readonly working: boolean; readonly thinking: boolean; readonly done: boolean }): ReactElement => (
  <img
    ...
    src={done ? talking : thinking ? thinkingPose : working ? usingTool : normal}
    alt={done ? "Tardie replying with a chat message" : thinking ? "Tardie thinking during a model call" : working ? "Tardie using a wrench during a tool call" : "Tardie"}
    width={570}
    height={410}
  />
)
