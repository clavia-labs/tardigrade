...
export const FactoryCounterexampleDiagram = (): ReactElement => (
  <figure className="factory-counterexample">
    <svg viewBox="0 0 460 180" role="img" aria-label="One failing path: inspect an empty ten-unit tank, produce six units of waste, then produce six more. The tank fills and two units spill outside.">
