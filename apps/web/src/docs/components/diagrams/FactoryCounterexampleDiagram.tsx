...
export const FactoryCounterexampleDiagram = (): ReactElement => (
  <figure className="factory-counterexample">
    <svg className="factory-counterexample-desktop" viewBox="0 0 460 180" role="img" aria-label="One failing path: inspect an empty ten-unit tank, produce six units of waste, then produce six more. The tank fills and two units spill outside.">
    ...
    <svg className="factory-counterexample-mobile" viewBox="0 0 320 470" role="img" aria-label="A vertical failing path inspects the tank, produces batch A, then produces batch B. The tank overflows by two units and the path ends at a mine.">
