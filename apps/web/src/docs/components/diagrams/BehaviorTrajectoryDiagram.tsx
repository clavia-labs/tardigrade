...
export const BehaviorTrajectoryDiagram = (): ReactElement => (
  <svg className="behavior-trajectory-diagram" viewBox="0 0 720 132" role="img" aria-label="Behavior along one trajectory" aria-describedby="behavior-trajectory-description">
