...
export const TrajectoryBranchesDiagram = (): ReactElement => (
  <svg className="trajectory-branches-diagram" viewBox="0 0 720 244" role="img" aria-labelledby="trajectory-branches-title trajectory-branches-description">
    ...
    <g className="trajectory-branches-time" aria-hidden="true">
      ...
      <path d="M24 226H696M690 220l6 6-6 6" />
      <text x="360" y="241" textAnchor="middle">TIME</text>
    </g>
  </svg>
)
