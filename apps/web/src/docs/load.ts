...
const markdown = import.meta.glob<string>("../../../../docs/site/**/*.mdx", { eager: true, import: "default", query: "?raw" })
...
export const docAt = (pathname: string): Doc | undefined => docs.find((doc) => doc.frontmatter.route === pathname)
