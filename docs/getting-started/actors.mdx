...
A good analogy is to think of actors like people we interact with, or even [Mr. Meeseeks from *Rick and Morty*](https://www.youtube.com/watch?v=l5wvqKcqL7c). People typically hold information that is accessible only to them. Others access this private information or elicit behaviors from them through communication.
