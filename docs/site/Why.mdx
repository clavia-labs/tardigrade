...
This idea has roots in finite state machines. A component in tardigrade is a finite state machine whose current output value is determined only by its current state. This is also known as a Moore Machine.
