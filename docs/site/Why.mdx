...
This idea has roots in automata theory. A component in tardigrade is a finite-state machine whose current output value is determined only by its current state. This is also known as a Moore Machine.
