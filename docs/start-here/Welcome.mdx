...
<div className="welcome-feature">
  <div className="welcome-feature-copy">
    ...
    <p>The log at the core supports native debugging, replay, and experiments with state forked from any checkpoint. Copy a thread's rows onto a new root with <code>tdg thread fork</code> or <code>host.forkThread</code>.</p>
  </div>
  <ForkingDiagram />
</div>
...
If you already use a handwritten loop, Pi, oh-my-pi, Vercel AI SDK, or Temporal, read [Comparing Tardigrade](/docs/comparisons).
