...
<div className="welcome-feature">
  <div className="welcome-feature-copy">
    ...
    <p>The log at the core supports native debugging, replay, and experiments with state forked from any checkpoint. Copy a thread prefix onto a new root with <code>tdg fork</code> or <code>host.forkThread</code>.</p>
  </div>
  <ForkingDiagram />
</div>
