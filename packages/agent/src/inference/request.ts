...
// the provider's own response-format surface (packages/agent/src/inference/model/output.ts, outputSchemaFor).
//
...
export type OutputRequest =
  | {
      ...
      // (packages/agent/src/inference/model/output.ts, outputModeOf).
