...
describe("modelRequest tool and prompt policy", () => {
  ...
  // binding decides whether the model ever reads it (packages/model/src/binding/output.ts, outputSystemFor).
  ...
  // (output.ts, DeclaredOutput; packages/model/src/binding/output.ts, outputPreflight).
