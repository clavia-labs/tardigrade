...
describe("modelRequest tool and prompt policy", () => {
  ...
  // binding decides whether the model ever reads it (packages/model/src/inference/output.ts, outputSystemFor).
  ...
  // (output.ts, DeclaredOutput; packages/model/src/inference/output.ts, outputPreflight).
