import { transitionKeyOf } from "@clavia/tardigrade-core/transition/transition"
import type { Event } from "@clavia/tardigrade-core/event"
import { methodIngressKeyOf } from "@clavia/tardigrade-core/interaction/invocation"
import { methodSealKeys } from "@clavia/tardigrade-core/interaction/seal"
...
export const hostEventKeyOf = (event: Event, applicationKeyOf?: (event: Event) => string | undefined): string | undefined =>
  transitionKeyOf(event) ?? methodIngressKeyOf(event) ?? methodSealKeys.keyOf(event) ?? threadKeys.keyOf(event) ?? applicationKeyOf?.(event)
