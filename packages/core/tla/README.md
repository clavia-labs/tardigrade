...
| `interaction/ExternalReply` | Keyed external readiness, matching package wakes, silent projection, and stable package-call identity | `ExternalReply.cfg` | `ExternalReplyCollapse.cfg`, `ExternalReplyDuplicateHead.cfg`, `ExternalReplyWakeAny.cfg`, `ExternalReplyNewTurn.cfg`, `ExternalReplyMethodTerminal.cfg`, `ExternalReplyNewPackage.cfg` |
