...
export class Writer extends Context.Tag("flamecast/Writer")<
  Writer,
  {
...
export class Wake extends Context.Tag("flamecast/Wake")<
  Wake,
  {
...
export class Placement extends Context.Tag("flamecast/Placement")<
  Placement,
...
export class Spill extends Context.Tag("flamecast/Spill")<
  Spill,
  {
...
export class Sink extends Context.Tag("flamecast/Sink")<
  Sink,
