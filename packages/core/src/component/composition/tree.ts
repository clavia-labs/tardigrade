 ...
 *              O₁        O₂             O₃       O₄
 *
 * Replacing one leaf recomputes only its path to the root. Stable branches retain their identity (component/composition/siblings.test.ts, "composition reuses branches whose child state identities are stable").
 */
