...
import { invocationDetachmentKeys } from "../interaction/detach"
...
export const compileActor = <R>(
  ...
  const semanticKeyOf = composeKeys(...fragments, invocationDetachmentKeys, cancellationKeys, methodCallKeys, methodTimeoutKeys, methodResponseKeys)
