...
// Transport reaches one and Self names this one. A facet is another lane's log seen from outside.
...
// shape either way. Beside Transport (deliver) and Self (identity) it completes the cross-lane
