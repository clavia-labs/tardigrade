...
// The code thread's explicit sandbox bindings. Sandbox is a Reference and defaults to this
// implementation, so a caller only provides a layer to override it. The spill store has no
// default: a thread names its backend by providing a KeyValueStore layer (spill.ts).
