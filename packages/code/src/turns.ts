...
const idOf = (e: Envelope): string => String((e as { id?: unknown }).id ?? "")
export const turnOf = (e: Envelope): string | undefined => {
...
const claimedByPark = (log: ReadonlyArray<Envelope>, index: number): boolean => {
...
export const trajectoryOf = (log: ReadonlyArray<Envelope>): ReadonlyArray<Envelope> => {
