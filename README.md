...
An agent is reactors over one log. Assemble one, give it a durable log, send it a message. This is [examples/quickstart.ts](examples/quickstart.ts), runnable as it stands:
