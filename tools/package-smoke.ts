...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { candidate, proposer, reflectivePrompts } from "flamecast-core/evolve"',
      "",
      'const agent = createAgent({ id: "smoke", modules: [inference({ contextWindow: 200_000 })] })',
      ...
      '    Effect.provide(inferWith(async () => ({ kind: "complete", output: "hello" }), { contextWindow: 200_000 })),',
