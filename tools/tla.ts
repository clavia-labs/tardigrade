...
export const checks: ReadonlyArray<Check> = [
  ...
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipDropCompletion.cfg", "Invariant EventOwner is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipOverride.cfg", "Invariant DeclarationOwner is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipNoScope.cfg", "Invariant ScopeCorrect is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipBareScope.cfg", "Invariant ScopeCorrect is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipNoEpoch.cfg", "Invariant CancellationIsolation is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipNoMethod.cfg", "Invariant CancellationIsolation is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipNoId.cfg", "Invariant CancellationIsolation is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipNoStartCheck.cfg", "Invariant NoCancelledStart is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipNoSignal.cfg", "Invariant CancellationObserved is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipNoResultCheck.cfg", "Invariant NoObservedCancelledResults is violated"),
  counterexample("runtime", "TransitionOwnership", "TransitionOwnershipUnfair.cfg", "PendingSettles was violated"),
  pass("runtime", "TransitionDeclarations", "TransitionDeclarations.cfg"),
  ...
  pass("cloudflare", "AlarmScheduler", "AlarmScheduler.cfg"),
  counterexample("cloudflare", "AlarmScheduler", "AlarmSchedulerLostWake.cfg", "Invariant OwedHasWake is violated"),
