...
export const checks: ReadonlyArray<Check> = [
  ...
  pass("runtime", "Cancellation", "Cancellation.cfg"),
  counterexample("runtime", "Cancellation", "CancellationIdentity.cfg", "Invariant ExactRequestTarget is violated"),
  counterexample("runtime", "Cancellation", "CancellationEffectLeak.cfg", "Invariant NoNewEffects is violated"),
  counterexample("runtime", "Cancellation", "CancellationNoSignal.cfg", "Invariant OldEffectsSignalled is violated"),
  counterexample("runtime", "Cancellation", "CancellationOpenCall.cfg", "Invariant OpenCallsTerminated is violated"),
  counterexample("runtime", "Cancellation", "CancellationChild.cfg", "Invariant ChildrenCancelled is violated"),
  counterexample("runtime", "Cancellation", "CancellationNoSettle.cfg", "CancellationSettles was violated"),
  counterexample("runtime", "Cancellation", "CancellationUnreachableChild.cfg", "CancellationSettles was violated"),
  pass("runtime", "CancellationDeadline", "CancellationDeadline.cfg"),
  pass("runtime", "CancellationParallel", "CancellationParallel.cfg"),
  counterexample("runtime", "CancellationParallel", "CancellationSerial.cfg", "CancellationSettles was violated"),
  pass("runtime", "InvocationPublication", "InvocationPublication.cfg"),
  counterexample("runtime", "InvocationPublication", "InvocationPublicationEarly.cfg", "Invariant PublishedChildrenOwned is violated"),
  pass("runtime", "InvocationEpoch", "InvocationEpoch.cfg"),
  counterexample("runtime", "InvocationEpoch", "InvocationEpochOverlap.cfg", "Invariant AtMostOneActive is violated"),
  counterexample("runtime", "InvocationEpoch", "InvocationEpochDetached.cfg", "Invariant ResumePreservesContext is violated"),
  pass("runtime", "InvocationDeadline", "InvocationDeadline.cfg"),
  counterexample("runtime", "InvocationDeadline", "InvocationDeadlineLocal.cfg", "Invariant ChildBoundedByParent is violated"),
  pass("runtime", "IncrementalProjection", "IncrementalProjection.cfg"),
  counterexample("runtime", "IncrementalProjection", "IncrementalProjectionSkip.cfg", "Invariant CacheSound is violated"),
  counterexample("runtime", "IncrementalProjection", "IncrementalProjectionStale.cfg", "Invariant NoStaleCommit is violated"),
  counterexample("runtime", "IncrementalProjection", "IncrementalProjectionSnapshot.cfg", "Invariant SnapshotSound is violated"),
  ...
  pass("runtime", "ProjectionAlgebra", "ProjectionAlgebra.cfg"),
  counterexample("runtime", "ProjectionAlgebra", "ProjectionAlgebraCurrent.cfg", "Invariant CurrentOutputSufficient is violated"),
  counterexample("runtime", "ProjectionAlgebra", "ProjectionAlgebraBalance.cfg", "Invariant BalanceOnlySufficient is violated"),
  pass("runtime", "ProjectionVersion", "ProjectionVersion.cfg"),
  counterexample("runtime", "ProjectionVersion", "ProjectionVersionGuess.cfg", "Invariant GuessMigrationSound is violated"),
  counterexample("runtime", "ProjectionVersion", "ProjectionVersionRefine.cfg", "Invariant CoarseSufficientForNew is violated"),
