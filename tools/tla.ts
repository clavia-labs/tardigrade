...
export const checks: ReadonlyArray<Check> = [
  ...
  pass("communication", "Reply", "Reply.cfg"),
  pass("communication", "Reply", "ReplyLive.cfg"),
  counterexample("communication", "Reply", "ReplyHint.cfg", "Invariant ReplyReversesAcceptedLink is violated"),
