...
behind Infer, a Node process: each binding is one subdirectory here, and it owns its own
...
planned tenant; `platform/cloudflare` arrives with the flamecast-v6 extraction.
